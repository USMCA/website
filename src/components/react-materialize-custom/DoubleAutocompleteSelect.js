/*******************************************************************************
 *
 * DoubleAutocompleteSelect: Queries on "name" and "email" and has value "_id".
 *
 ******************************************************************************/
...
class DoubleAutocompleteSelect extends React.Component {
  constructor (props) {
    super(props);
...
DoubleAutocompleteSelect.propTypes = {
...
export default DoubleAutocompleteSelect;
